class Message {
    ...
    static getTotalMatch (three, four, five, bonus, six) {
      return `${this.THREE_MATCH}${three}${this.UNIT}\n${this.FOUR_MATCH}${four}${this.UNIT}\n${this.FIVE_MATCH}${five}${this.UNIT}\n${this.FIVE_BONUS_MATCH}${bonus}${this.UNIT}\n${this.SIX_MATCH}${six}${this.UNIT}`;
    }
