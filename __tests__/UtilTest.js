...
describe('Util 클래스 테스트', () => {
  ...
  test('배열 요소 모두 정해진 범위에 해당하는지 여부를 반환한다.', () => {
  ...
  test('숫자string이 정해진 범위에 해당하는지 여부를 반환한다.', () => {
