...
describe('기능테스트', () => {
  test('수익률 테스트1', () => {
    ...
    const app = new App();
    app.play();
    expect(app.controller.calculate.getEarningRate([1, 0, 0, 0, 0])).toContain('62.5');
  });
  test('수익률 테스트2', () => {
    mockRandoms([
      [8, 21, 23, 41, 42, 43],
    ...
    const app = new App();
    app.play();
    const result = app.controller.checklotto.getWinningresult();
    expect(app.controller.calculate.getEarningRate(result)).toContain('375062.5');
  });
  test('1000원단위 로또생성 테스트1', () => {
    mockRandoms([
      [8, 21, 23, 41, 42, 43],
      [3, 5, 11, 16, 32, 38],
      [7, 11, 16, 35, 36, 44],
  ...
  test('로또 비교 테스트', () => {
    ...
    const app = new App();
    app.play();
    expect(app.controller.checklotto.getWinningresult()).toEqual([1, 0, 0, 0, 0]);
  });
  test('로또 비교 테스트1', () => {
    mockRandoms([
      [8, 21, 23, 41, 42, 43],
