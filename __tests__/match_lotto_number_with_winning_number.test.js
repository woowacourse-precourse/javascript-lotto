const matchLottoNumberWithWinningNumber = require('../src/components/util/matchLottoNumberWithWinningNumber');
const {
  LottoNumberData,
  LottoRanking,
...
describe('matchLottoNumberWithWinningNumber 함수 테스트', () => {
  beforeEach(() => {
