...
describe('판단기 클래스 테스트', () => {
  ...
  test('로또 번호와 당첨 번호가 몇개 일치하는지 센다.', () => {
    expect(Judge.countCorrect(lotto1st, winningNumbers)).toEqual(6);
    expect(Judge.countCorrect(lotto2nd, winningNumbers)).toEqual(5);
    expect(Judge.countCorrect(lotto3rd, winningNumbers)).toEqual(5);
