class ErrorMsg {
  ...
  static INVALID_PAY_EMPTY_STRING = "[ERROR] 입력값이 없습니다.";
  static INVALID_PAY_NOT_NUM = "[ERROR] 구입금액은 숫자만 입력할 수 있습니다.";
  static INVALID_PAY_UNIT = "[ERROR] 구입금액은 1000원 단위로 입력해야합니다.";

  static INVALID_WINNING_EMPTY_STRING = "[ERROR] 입력값이 없습니다.";
  ...
  static INVALID_BONUS_EMPTY_STRING = "[ERROR] 입력값이 없습니다.";
