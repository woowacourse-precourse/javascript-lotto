...
const ERROR_MESSAGE = Object.freeze({
  HAS_BLACK: '[ERROR] 입력에 공백을 포함시킬 수 없습니다.',
  START_WITH_ZERO: '[ERROR] 정수의 앞에 0이 올 수 없습니다.',
  OUT_OF_RANGE: '[ERROR] 1에서 45까지의 숫자를 입력해야 합니다.',
  INT_FORM: '[ERROR] 음이아닌 정수를 입력해야 합니다.',
  HAS_MOD: '[ERROR] 1000의 배수를 입력해야 합니다.',
  WINNING_NUM_FORM: '[ERROR] 숫자를 ,로 구분해 입력해야 합니다.',
  LENGTH: '[ERROR] 로또 번호는 6개여야 합니다.',
  DUPLICATION: '[ERROR] 중복된 숫자를 입력할 수 없습니다.',
  WINNING_HAS: '[ERROR] 이미 당첨 번호에 포함된 번호를 입력할 수 없습니다.',
});
