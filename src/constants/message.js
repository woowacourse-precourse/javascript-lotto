...
const MESSAGE = {
  ...
  ERROR: {
    ...
    WINNING_NUMBER_COUNT: `[ERROR] 당첨 번호를 입력할 때 숫자 ${LOTTO.WINNING_NUMBER_COUNT}가지를 입력해주세요!`,
    BONUS_NUMBER_COUNT: `[ERROR] 당첨 번호를 입력할 때 숫자 ${LOTTO.BONUS_NUMBER_COUNT}가지를 입력해주세요!`,
