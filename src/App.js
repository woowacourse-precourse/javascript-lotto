...
class App {
  ...
  generateLottoNum() {
    for (let i = 0; i < this.lottoCount; i++) {
      let lottoRandomNum = MissionUtils.Random.pickUniqueNumbersInRange(
        1,
        45,
        6
      );
    ...
    this.printLottoNumArr(this.lottoNumArr);
  }

  printLottoNumArr(lottoNumArr) {
    lottoNumArr.map((eachlottoNum) =>
      MissionUtils.Console.print(`[${eachlottoNum.join(", ")}]`)
    );
  }
