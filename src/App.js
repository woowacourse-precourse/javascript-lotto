...
const showCount = (first, second, third, fourth, fiveth,lottos) => {
  Console.print("당첨 통계\n---");
  ...
  plusRate(fivethMoney,fourthMoney,thirdMoney,secondMoney,firstMoney,lottos);
}

const plusRate = (first, second, third, fourth, fiveth,lottos) => {
  let allPlus = first + second + third + fourth + fiveth;
  let lottoLength = lottos.length;
  let returnRate = (allPlus/lottoLength)/100;
