...
2. 당첨번호 입력 테스트
   ...
   - 2-1 ","와 숫자 이외의 값을 받았을 때
   - 2-2 배열로 받은 숫자가 더 많을때
   - 2-3 ","가 두번이상 연속으로 입력되었을 때
   - 2-4 중복되는 숫자를 입력받았을 때,
   - 2-5 ,가 먼저 입력되었을 때
     </br>

3. 보너스번호 입력 테스트

   - 3-1 숫자가 아닌 값을 입력했을 때
   - 3-2 로또 숫자 범위가 아닌 값을 입력했을 때
   - 3-3 당첨번호와 중복되는 값을 입력했을 때  
     </br>
