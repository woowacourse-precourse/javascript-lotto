...
- [x] 보너스 번호 입력 받기
  - [x] 1~45사이의 숫자가 아닌 경우 예외 처리하기
  - [x] 하나의 숫자가 아닌 경우 예외 처리하기
...
- [x] 당첨 내역 출력하기
  - [x] 로또의 순위 별 개수를 확인하는 기능
  - [x] 로또 번호와 당첨 번호 비교하는 기능
  - [x] 모든 로또를 당첨 번호와 비교하기
  - [x] 위와 같이 일치 개수에 따른 당첨 내역 출력하기
...
- [x] 수익률 출력하기
  - [x] 당첨된 총 금액 구하기
  - [x] 입력받은 로또 구입 금액과 당첨금을 통해 수익률 계산하기
  - [x] 수익률은 소수점 첫째 자리까지만 출력하기
