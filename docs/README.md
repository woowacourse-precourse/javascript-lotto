...
- [ ] 로또 구매 가격을 입력할 수 있다.
  - [ ] 1000원 단위의 값을 입력해야 한다.
  - [ ] `예외 사항`이 있다면 예외를 발생시키고 에러 메세지를 출력 후 종료한다.
- [ ] 구매 가격에 따른 로또 구매 수량을 알 수 있다.
  - [ ] 1000(원)에 로또를 1장 구매할 수 있다.
- [ ] 구매 수량에 따른 구매한 로또 번호를 알 수 있다.
  - [ ] 한 로또 번호에 1~45 중 서로 다른 6개의 수가 들어간다.
  - [ ] 로또 번호는 오름차순으로 정렬된다.

### 2. 당첨 번호 입력하기

- [ ] 로또 당첨 번호를 입력할 수 있다.
  - [ ] 숫자 외에 다른 값이 들어갈 수 없다.
  - [ ] 숫자 구분은 ,(쉼표)로 한다.
