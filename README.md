...
![image](https://user-images.githubusercontent.com/27201591/201940120-371aaaee-9fab-4f37-9812-bbdfc8c6fc28.png)

# 1️⃣ 로또 게임 설명

`우아한테크코스 5기 프리코스`를 진행하면서 3주차 미션으로 진행된 **로또 게임**입니다!
...
- 이때!
    - 숫자만 입력해주세요.
    - 1000원 단위로 입력해주세요.
    - 10억이 넘어가면 안됩니다. (~~도박 조심!~~)

### 2) 로또 번호를 받는다.

- 로또는 한 장에 천 원입니다.
- 로또 번호를 구입 금액에 맞춰 받습니다.
- 로또 번호는 랜덤입니다.
- 로또 번호는 1~45 숫자들입니다.
...
- 이때!
    ...
    - 숫자만 입력해주세요.
    - 1~45 숫자만 입력해주세요.
    - 이전에 입력한 당첨 번호와 중복되면 안됩니다.

### 5) 당첨 통계를 확인한다.

- 입력한 숫자들을 토대로 당첨 통계를 출력해드립니다.
